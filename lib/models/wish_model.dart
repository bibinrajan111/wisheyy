...
enum RevealTrigger { none, tap, hold, swipe, shake }

enum FinishType { normal, matte, metallic }
...
class WishComponentModel {
  const WishComponentModel({
    ...
    this.revealTrigger = RevealTrigger.none,
  });
  ...
  final RevealTrigger revealTrigger;
  ...
  Map<String, dynamic> toJson() => {
        ...
        'revealTrigger': revealTrigger.name,
      };
  ...
  factory WishComponentModel.fromJson(Map<String, dynamic> json) => WishComponentModel(
        ...
        revealTrigger: RevealTrigger.values.byName(
          json['revealTrigger'] as String? ?? RevealTrigger.none.name,
        ),
      );
  ...
  WishComponentModel copyWith({
    ...
    return WishComponentModel(
      ...
      locked: locked ?? this.locked,
      actionType: actionType ?? this.actionType,
      revealTrigger: revealTrigger ?? this.revealTrigger,
    );
  }
}
...
class WishPageModel {
  ...
  factory WishPageModel.fromJson(Map<String, dynamic> json) => WishPageModel(
        ...
        backgroundImageUrl: json['backgroundImageUrl'] as String?,
        backgroundVideoUrl: json['backgroundVideoUrl'] as String?,
        finish: FinishType.values.byName(json['finish'] as String? ?? FinishType.normal.name),
        components: (json['components'] as List<dynamic>? ?? const [])
            .map((e) => WishComponentModel.fromJson(e as Map<String, dynamic>))
            .toList(),
      );
